    ...
    >
      ...
      <NavLink onClick={()=>{
        ...
        history.push("/academy")
         ...
         <span  style={{marginLeft:'50px',color:'black'}}><b>Sing In</b></span>
        </NavLink>
      
      <NavLink href="/academy/beamember" style={{ textDecoration: "none" }}>
         <span  style={{marginLeft:'20px',color:'black'}}><b>Be a Member</b></span>
        </NavLink>
      
      <NavLink href="/" style={{ textDecoration: "none" }}>
         <span  style={{marginLeft:'20px',color:'black'}}><b>Forum</b></span>
        </NavLink>
     
      <NavLink href="/" style={{ textDecoration: "none" }}>
         <span  style={{marginLeft:'20px',color:'black'}}><b>Extras</b></span>
        </NavLink>
      </div>
      <div>
